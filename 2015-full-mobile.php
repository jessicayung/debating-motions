  ...
  <body>
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      ...
      <div class="container">
        ...
        <p> <a href="2015-full.php">Expanded version</a></p>
      ...
      <?php 
                  ...
                  $sql = "SELECT Round, Date, Motion, Tournament FROM Motions WHERE Date >= '20150101' ORDER BY Date DESC, RoundCode ASC
                  ";
